            ...
            <div className="shipping-section">
                ...
                <form className="shipping-form">
                    <div className="input-group">
                        <label>Nom*</label>
                        <input type="text" placeholder="No business or company name" />
                    </div>
                    <div className="input-group">
                        <label>Adresse*</label>
                        <input type="text" />
                    ...
                    <div className="input-group">
                        ...
                        <input type="text" placeholder="+33 xxx xxx xxx" />
                    </div>
                </form>
            </div>
            ...
            <div className="payment-section">
                ...
                <form className="payment-form">
                    ...
                    <div className="input-group">
                        ...
                        <input type="text" placeholder="Carl Bourges" />
                    </div>
                    <button className="btn btn-primary">Confirmer et acheter de l'espace</button>
                </form>
            </div>
        </div>
    );
