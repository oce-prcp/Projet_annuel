...
const SubscriptionPage = () => {
    ...
    const validateCardName = (name) => /^[a-zA-ZÀ-ÿ\s'-]+$/.test(name);
    ...
    const handleValidation = () => {
        ...
        if (!validateCvc(cvc)) {
            newErrors.cvc = 'CVC / CVV invalide';
        }
        if (!validateCardName(cardName)) {
            newErrors.cardName = 'Nom inscrit sur la carte invalide';
        }
        setErrors(newErrors);
    ...
    const handleSubscription = async (e) => {
        ...
        try {
            ...
            if (subscriptionResponse.status === 201) {
                const subscriptionCreateResponse = await axios.post(
    ...
    if (!userId) {
        ...
        return (
            <Container className="page-container">
                <Container className="payement-container">
                    <Container className="payement-element">
                        <div className='payement-header'>
                            <h2 className="mt-4">Paiement</h2>
                            <p>Toutes les transactions sont sécurisées et chiffrées.</p>
                        </div>
                        <Card className="p-4 payement-card">
                            <Form onSubmit={handleSubscription}>
                                ...
                                <Row className='cb-short-info'>
                                    ...
                                    <Form.Group className="mb-3" controlId="formCVC">
                                        <Form.Label>Code de sécurité (CVC / CVV)</Form.Label>
                                        <Form.Control 
                                            type="text" 
                                ...
                                <Form.Group className="mb-3" controlId="formBillingAddress">
                                    <Form.Check 
                                        type="checkbox" 
                                        label="Utiliser l'adresse d'expédition comme adresse de facturation" 
                                        defaultChecked 
                                    />
                                </Form.Group>
                                ...
                                <Button type="submit" className="w-100 mt-3 button-buy">
                ...
                <Container className="product-container">
                    <div className='product-detail'>
                        <Row>
                            <Col xs={3}>
                                <Card.Img src="./img/logo-datasave.png" alt="Product Image" style={{ width: '100%', borderRadius: '8px' }} />
                            </Col>
                            <Col xs={6}>
                                <Card.Body>
                                    <Card.Title>Espace de stockage</Card.Title>
                                    <Card.Text>
                                        20Go d'espace de stockage pour vos fichiers et documents.
                                    </Card.Text>
                                </Card.Body>
                            </Col>
                            <Col xs={3} className="text-end">
                                <Card.Text style={{ fontWeight: 'bold', fontSize: '1.2em' }}>20,00 €</Card.Text>
                            </Col>
                        </Row>
                        <Row className="mt-3">
                            <Col xs={6}>
                                <Card.Text>Sous-total HT</Card.Text>
                            </Col>
                        ...
                        <Row className="mt-3">
                            <Col xs={6}>
                                <Card.Text>Sous-total</Card.Text>
                            </Col>
                            <Col xs={6} className="text-end">
                        ...
                        <Row>
                            <Col xs={6}>
                                <Card.Text style={{ fontWeight: 'bold', fontSize: '2em' }}>Total</Card.Text>
                            </Col>
                            <Col xs={6} className="text-end">
                                <Card.Text style={{ fontWeight: 'bold', fontSize: '2em' }}>20,00 €</Card.Text>
                            </Col>
                        </Row>
                        <Card.Text style={{ color: '#777' }}>
                            Taxes de 4.00€ incluse
                        </Card.Text>
                    </div>
                </Container>
            </Container>
